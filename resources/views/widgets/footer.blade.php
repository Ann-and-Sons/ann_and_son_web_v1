    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap">
        <div class="w-full lg:w-6/12 px-4">
          ...
          <a href="https://www.linkedin.com/company/ann-and-sons-limited/" target="_blank" rel="noopener noreferrer">
          <svg fill="#ffffff" width="50px" height="50px" viewBox="-5.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
