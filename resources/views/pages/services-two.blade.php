...
<body>
    ...
    <section class=" bg-zinc-950">
        <div class="container py-8 p-5 px-10">
            <p class="flex justify-start text-gray-400 mb-5 px-48 text-xl">Finding the right leaders is crucial for driving your organization's success and growth. <br>
        ...
        <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              <div class="mt-4 space-y-12">
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg font-medium text-white leadi ">Headhunting</h4>
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg font-medium leadi text-white">Interactive Learning Resources</h4>
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg text-white font-medium leadi ">Graduate recruitment</h4>
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg text-white font-medium leadi ">Recruitment Process Outsourcing (RPO). </h4>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                      <h4 class="text-lg text-white font-medium leadi ">Leadership & Behavioral Assessments (Online)</h4>
            ...
            <div aria-hidden="true" class="mt-10 lg:mt-0">
              <img width="600" height="600" src="{{ asset('assets/images/bg/recruit.jpg') }}" class="mx-auto rounded-lg shadow-lg dark-bg-gray-500" style="color:transparent">
            </div>
          </div>
        </div>
    </section>
