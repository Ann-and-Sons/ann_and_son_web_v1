...
<head>
    ...
    <title>Executive Search & Recruitment</title>
</head>
...
<body>
    ...
    <section class=" relative py-12 lg:py-40 shadow-lg overflow-hidden lg:max-h-[500px] lg:min-h-[500px] pb-8">
        <img src="{{ asset('assets/images/bg/service-2.jpg') }}" alt="Partnership"
                ...
                <div class="lg:pt-12 lg:w-8/12 pt-6 w-full md:w-4/12 px-4">
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-8 lg:mb-0">
                        <div class="px-4 py-10 text-white flex-auto bg-black shadow-lg">
                            <h1 class="font-sans text-2xl md:text-3xl">
    ...
    <section class="bg-zinc-950">
        <div class="container py-8 p-5 px-6 sm:px-10">
            <p class="text-gray-400 mb-5 text-lg sm:text-xl">
                Finding the right leaders is crucial for driving your organization's success and growth. <br>
                Our Executive Search & Recruitment services are designed to identify and attract top-tier <br> talent for your senior leadership positions.
                With an extensive network and a deep <br> understanding of various industries, we meticulously search for candidates <br> who not only possess
                the required skills and experience but also <br> align with your company’s culture and strategic objectives.
            </p>
        </div>
    </section>
            ...
            <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                <div class="space-y-12">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-white">Headhunting</h4>
                            <p class="mt-2 text-gray-400">We proactively identify and attract top-tier talent tailored to your organization's specific needs.</p>
                        </div>
                    </div>
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-white">Interactive Learning Resources</h4>
                            <p class="mt-2 text-gray-400">We specialize in finding and securing high-caliber executives who align with your strategic goals.</p>
                        </div>
                    </div>
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center w-12 h-12 text-white rounded-md">
                                <svg fill="#000000" width="20px" height="20px" viewBox="0 0 846.66 846.66" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        <style type="text/css">
                                            <![CDATA[
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-white">Graduate recruitment</h4>
                            <p class="mt-2 text-gray-400">We attract and assess exceptional graduates to build a strong pipeline of future leaders.</p>
                        </div>
                    </div>
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-white">Recruitment Process Outsourcing (RPO)</h4>
                            <p class="mt-2 text-gray-400">We manage your entire recruitment process, delivering high-quality talent efficiently and cost-effectively.</p>
                        </div>
                    </div>
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-white">Leadership & Behavioral Assessments (Online)</h4>
                            <p class="mt-2 text-gray-400">We provide online assessments to evaluate and develop your leadership team's competencies and behaviors.</p>
                        </div>
                    </div>
                </div>
                <div aria-hidden="true" class="mt-10 lg:mt-0">
                    <img width="600" height="600" src="{{ asset('assets/images/bg/recruit.jpg') }}" class="mx-auto rounded-lg shadow-lg" style="color:transparent">
                </div>
            </div>
        </div>
    </section>
