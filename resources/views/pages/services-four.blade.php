                ...
                <div>
                    <div class="mt-4 space-y-12">
                        <div class="flex">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-medium text-white leadi ">Organizational Design</h4>
                                <p class="mt-2 text-gray-400">Integrate structure, process and people for a holistic
                                    impact.</p>
                            </div>
                        </div>
                        <div class="flex">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-medium leadi text-white">Organizational Agility</h4>
                                <p class="mt-2 text-gray-400">Develop more agile ways of working across the entire
                                    organization</p>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center w-12 h-12 text-white rounded-md">
                                    <svg fill="#000000" width="20px" height="20px" viewBox="0 0 846.66 846.66"
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg text-white font-medium leadi ">Culture and Change</h4>
                                <p class="mt-2 text-gray-400">Drive lasting improvement in performance and
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg text-white font-medium leadi ">Organizational
                                    review/Structuring/Restructuring. </h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div aria-hidden="true" class="mt-10 lg:mt-0">
                    <img width="600" height="600" src="{{ asset('assets/images/bg/organize.jpg') }}"
